...
import 'package:tour_info/data/listData.dart';
import 'package:tour_info/data/tour.dart';
...
class _MapPage extends State<MapPage> {
  ...
  String authKey =
      'isQye9%2BStuIFzEoekkDoTEybVfLYV6tu3xISj8hNPS31UV19aUiUN%2Fo%2BwLfHxQ7f0QPwmTguRKHVn8r6NauwZA%3D%3D';
  Item area = null;
  Item kind = null;
  int page = 1;
  ...
  void getAreaList({int? area, int? contentTypeId, int? page}) async {
    var url =
        ...
        'https: //apis.data.go.kr/B551011/KorService/areaBasedList?serviceKey=$authKey &numOfRows=10&pageNo=$page&MobileOS=AND&MobileApp=tour_info&_type=json&listYN=Y&arrange=C& sigunguCode = $area';
    if (contentTypeId != 0) {
