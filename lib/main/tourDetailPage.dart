...
import 'package:tour_info/data/disableInfo.dart';
import 'package:tour_info/data/reviews.dart';
...
class _TourDetailPage extends State<TourDetailPage> {
  ...
  CameraPosition _GoogleMapCamera = null;
  TextEditingController _reviewTextController = null;
  Marker marker = null;
  List<Review> reviews = List();
  bool _disableWidget = false;
  DisableInfo _disableInfo = null;
